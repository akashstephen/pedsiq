    ...
    <div className="-mx-4 -mt-16 min-h-screen bg-[var(--clinical-bg)] px-4 py-8 text-[var(--clinical-ink)] md:-mx-8 md:-mt-8 md:px-8">
      <div className="mx-auto max-w-[var(--content-max)] space-y-8">
        <header className="grid gap-6 pt-10 lg:grid-cols-[1.25fr_0.75fr] lg:items-end">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-base leading-7 text-[var(--clinical-ink-soft)]">
              Track question volume, topic coverage, retrieval exposure, and open review load.
            </p>
          </div>

          <LearningPanel title="Activity summary" eyebrow="Local data">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          <LearningPanel title="Coverage" eyebrow="Breadth">
            <MasteryMeter
          ...
          <LearningPanel title="Retrieval" eyebrow="Practice volume">
          ...
          <LearningPanel title="Review load" eyebrow="Notebook">
            <div className="flex items-center gap-4">
        ...
        <div className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="space-y-5">
            <LearningPanel title="Recent activity" eyebrow="Last 7 days">
              <div className="flex items-center gap-4">
            ...
            <LearningPanel title="Recommended next steps" eyebrow="Keep it practical">
              <div className="space-y-3">
            ...
            <div className="rounded-[var(--panel-radius)] border border-[var(--clinical-amber)]/20 bg-[var(--clinical-amber-soft)] p-4 text-sm leading-7 text-[var(--clinical-ink-soft)]">
              ...
              Mastery is not scored until repeated retrieval across time is available. Current metrics show activity,
