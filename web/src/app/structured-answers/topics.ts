...
export const topics: Topic[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          '<strong>Associated:</strong> Oliguria, mild proteinuria (&lt;1 g/day), azotemia (fatigue, nausea, anorexia), fever, flank pain, hypertensive encephalopathy (headache, seizures, papilledema), <strong>heart failure</strong> (severe HTN)'
        ],
      },
      {
      ...
      },
      {
        ...
        list: [
          ...
          '<strong>Hypertension:</strong> Calcium channel blockers (Amlodipine), ACE inhibitors. Emergency: IV Labetalol or Nitroprusside.',
          ...
          '<strong>Negative point:</strong> <strong>NO role for corticosteroids or immunosuppressants</strong> in APSGN — therapy is supportive only.',
        ],
        flowchart: {
          nodes: [
      ...
      },
      {
        ...
        list: [
          ...
          '<strong>Hypertensive encephalopathy</strong> — seizures, papilledema, <strong>heart failure</strong> (severe HTN)',
    ...
    checklist: [
      ...
      'Clinical triad: Hematuria (RBC casts) + Edema + Hypertension; azotemia, heart failure risk - <strong>1M</strong>',
      'Investigations: Urine RBC casts, low C3 (normal C4), high ASO/Anti-DNase B - <strong>1M</strong>',
      'General management: Bed rest, salt/fluid restriction, daily monitoring - <strong>0.5M</strong>',
      'Specific Rx: Pediatric penicillin dosing, diuretics, antihypertensives - <strong>0.5M</strong>',
      'Negative point: NO corticosteroids/immunosuppressants in APSGN - <strong>0.5M</strong>',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          '<strong>Adjunctive:</strong> <strong>ACE inhibitors</strong> (Enalapril) for persistent HTN/proteinuria.',
    ...
    checklist: [
      ...
      'Clinical: Periorbital edema, frothy urine, ascites, hypovolemia signs; typical MCNS has no hematuria/HTN/low C3 - <strong>1M</strong>',
      ...
      'Adjunctive: ACE inhibitors for persistent HTN/proteinuria; loop diuretics for edema - <strong>0.5M</strong>',
  ...
  },
  {
    ...
    checklist: [
      ...
      'Clinical features: Craniotabes, rachitic rosary, wrist widening, bow legs, delayed motor milestones, myopathy, hypocalcemic seizures/tetany - <strong>2M</strong>',
