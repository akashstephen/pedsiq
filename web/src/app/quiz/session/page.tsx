...
import { createSession, recordResponse, isSessionComplete, saveActiveSession, clearActiveSession, loadActiveSession } from '@/lib/session';
...
export default function QuizSessionPage() {
  ...
  useEffect(() => {
    ...
    // Create new session from URL params
  ...
  const handleAnswer = useCallback(
    (index: number) => {
      ...
      // Update performance immediately (without confidence yet)
      updatePerformance(currentQuestion, {
        questionId: currentQuestion.id,
        selectedIndex: index,
        correct,
        timeSpentMs: timeSpent,
        confidence: 'unsure', // Will update when confidence is rated
      });
    },
  ...
  const handleConfidenceRated = useCallback(
    (conf: ConfidenceLevel) => {
      ...
      // Update the response with final confidence
